        ...
        >
          ...
          <Grid container>
            <Grid item xs={4} md={2}>
              ...
              >
                {" "}
                <img src={fbimg} alt="" class="social_img" srcset="" />
              </a>
            </Grid>
            <Grid item xs={4} md={2}>
              <a href="https://www.instagram.com/hack36_/" class="social_img">
                <img src={instaimg} alt="" class="social_img" srcset="" />
              </a>
            </Grid>
            <Grid item xs={4} md={2}>
              {" "}
              <a href="https://www.linkedin.com/company/hack36/">
                <img src={linkedInimg} alt="" class="social_img" srcset="" />
              </a>
            </Grid>
            <Grid item xs={4} md={2}>
              <a href="https://twitter.com/hack36mnnit">
                {" "}
                <img src={twitimg} alt="" class="social_img" srcset="" />
              </a>
            </Grid>
            <Grid item xs={4} md={2}>
              <a href="hackathon@mnnit.ac.in">
                <img src={mailimg} alt="" class="social_img" srcset="" />
              </a>
            </Grid>
            <Grid item xs={4} md={2}>
